...
from pylabscanner.devices import BoloMsgSensor, BoloMsgSamples, BoloMsgFreq
from pylabscanner.commands import LineType, LineStart
    ...
    for z in measurement_range_z:
        for y in measurement_range_y:
            ...
            data_line = {
                ...
                'MEASUREMENT': _generate_fake_line_data(measurement_range_x.size, no_samp)
            }
